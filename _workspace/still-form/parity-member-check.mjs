...
const MEMBER = { email: 'qa-member@stillform.test', password: '<redacted-pw>member' };
...
out.loggedIn = (await page.locator('header, nav, body').first().textContent()).includes('QA멤버');
...
await m.waitForSelector('[data-testid="checkout-form"]', { timeout: 15000 });

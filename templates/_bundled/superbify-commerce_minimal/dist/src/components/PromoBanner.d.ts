 ...
 */
export declare function PromoBanner({ eyebrow, title, description, ctaLabel, ctaHref, className, mediaSlot, mediaSrc, layout, }: PromoBannerProps): React.ReactElement;

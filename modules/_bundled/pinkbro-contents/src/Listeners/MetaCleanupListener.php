...
namespace Modules\Pinkbro\Contents\Listeners;
...
/**
 * 게시글/게시판 삭제 시 pinkbro_meta 고아 행을 정리합니다.
 *
 * G7 규정(DB CASCADE 금지, 어플리케이션 명시 삭제)에 따라
 * sirsoft-board 삭제 흐름에 연동됩니다. 리스너는 멱등해야 합니다.
 */
class MetaCleanupListener implements HookListenerInterface
{
    /**
     * 구독할 훅 목록을 반환합니다.
     *
     ...
     *
     * 사이트 레벨 메타(board_id·post_id 둘 다 null)는 post_id 조건이
     * int 값 비교라 어차피 걸리지 않는다.
     *

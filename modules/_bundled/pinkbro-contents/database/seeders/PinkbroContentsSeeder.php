...
class PinkbroContentsSeeder extends Seeder
{
    ...
    private const FAQ = [
        [
            ...
            'answer' => '바닥 기계세척은 기본 250,000원부터 시작합니다. 데코타일, 20평 미만, 기본 오염 조건 기준이며 면적, 집기 이동, 특수오염, 코팅·박리 여부 등에 따라 최종 금액이 달라질 수 있습니다.',
            'sort' => 1,
        ],
        [
            'question' => '카페·음식점 유리창 세척 비용은 얼마인가요?',
            'answer' => '유리창 세척은 기본 100,000원부터 시작합니다. 1층, 총 가로 10m × 높이 2m 이내, 기본 오염 기준이며 심한 물때·석회, 시트지·본드 제거, 창틀 집중세척, 고소작업은 추가비용이 발생할 수 있습니다.',
            'sort' => 2,
        ],
        [
            'question' => '상업용 후드 세척 비용은 얼마인가요?',
            'answer' => '상업용 후드 세척은 기본 250,000원부터 시작합니다. 일반 규모 후드의 기본 기름오염과 기본 내부·외부 세척 기준이며 후드 길이, 필터 수량, 누적 기름때, 덕트·팬·추가 분해 범위에 따라 달라질 수 있습니다.',
            'sort' => 3,
        ],
        [
            'question' => '에어컨 분해세척은 종류별로 가격이 다른가요?',
            'answer' => '네. 기본가는 벽걸이 80,000원~, 스탠드 120,000원~, 천장형 1WAY 100,000원~, 천장형 4WAY 150,000원~입니다. 기종, 대수, 분해 난도, 오염 상태와 접근성에 따라 확정 견적이 달라질 수 있습니다.',
            'sort' => 4,
        ],
        [
            'question' => '홈페이지에 표시된 금액이 최종 확정가격인가요?',
            'answer' => '아닙니다. 홈페이지 금액은 기본 작업 기준가입니다. 실제 확정 견적은 면적, 수량, 오염도, 작업 구조, 접근성, 고소장비 및 추가 작업 범위를 확인한 뒤 안내합니다.',
            'sort' => 5,
        ],
        [
            'question' => '여러 서비스를 같은 날 함께 맡기면 할인이 있나요?',
            'answer' => '같은 매장·같은 일정 기준으로 2개 항목 3%, 3~4개 항목 5%, 5개 이상 10% 할인이 적용됩니다. 할인은 기본 작업금액 합계 기준이며 특수오염, 추가면적, 고소장비, 장비대여 등 추가비용은 제외됩니다.',
            'sort' => 6,
        ],
        [
            'question' => '어느 지역까지 출장 가능한가요?',
            'answer' => '부산·울산·경남 전 지역을 기본 출장지역으로 안내하고 있습니다. 현장 위치와 작업 내용에 따라 일정 및 출장 가능 여부를 상담 단계에서 확인해 드립니다.',
            'sort' => 7,
        ],
        [
            'question' => '사진을 보내서 견적 문의하려면 어떻게 하나요?',
            'answer' => '현장 사진은 카카오채널로 보내주시면 가장 편리합니다. 휴대폰으로 촬영한 매장 전체와 관리가 필요한 부분 사진을 카카오채널로 보내주세요. 홈페이지에서는 사진 없이 업종, 필요 서비스, 규모, 연락처와 요청사항만 남겨도 문의할 수 있습니다.',
            'sort' => 8,
        ],
    ];
